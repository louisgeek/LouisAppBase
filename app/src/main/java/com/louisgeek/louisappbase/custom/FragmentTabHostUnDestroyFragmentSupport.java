 ...
 * //2016-11-4 15:19:32
 *
 * copy all code form  android.support.v4.app.FragmentTabHost
 *
 * version  is   support-fragment-24.2.1
 *
 * change  ft.detach(),ft.attach()  to  ft.hide(),ft.show()
 */
 ...
 *      complete}
 */
public class FragmentTabHostUnDestroyFragmentSupport extends TabHost
    ...
    public FragmentTabHostUnDestroyFragmentSupport(Context context) {
    ...
    public FragmentTabHostUnDestroyFragmentSupport(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private FragmentTransaction doTabChanged(String tabId, FragmentTransaction ft) {
        ...
        if (newTab == null) {
            /**
             * 2016-11-4 16:07:27  just for keep in xml
             *
             * you can  change it back for yourself
             *
             *  throw new IllegalStateException("No tab known for tag " + tabId);
              */
            Log.e("FragmentTabHostUnDestr_", "_oyFragmentSupport: doTabChanged: throw new IllegalStateException(\"No tab known for tag \" + tabId)");
            //####!!!!!  throw new IllegalStateException("No tab known for tag " + tabId);
        }
        if (mLastTab != newTab) {
            if (ft == null) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                     ...
                     *
                     *  change  ft.show(mLastTab.fragment);
                     */
