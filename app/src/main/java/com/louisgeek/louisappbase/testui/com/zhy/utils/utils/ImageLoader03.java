package com.louisgeek.louisappbase.testui.com.zhy.utils.utils;
...
{
	private static ImageLoader03 mInstance;
	...
	private static final String TAG = "ImageLoader03";
	...
	private ImageLoader03(int threadCount, Type type)
	{
	...
	public static ImageLoader03 getInstance()
	{
		if (mInstance == null)
		{
			synchronized (ImageLoader03.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoader03(DEAFULT_THREAD_COUNT, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	public static ImageLoader03 getInstance(int threadCount, Type type)
	{
		if (mInstance == null)
		{
			synchronized (ImageLoader03.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoader03(threadCount, type);
				}
			}
		}
		return mInstance;
