...
public class KooHFJokeRecyclerAdapter extends HeaderFooterRecyclerAdapter<JokeImageAndTextListBean.ContentlistBean>{
    ...
    public KooHFJokeRecyclerAdapter(int jokeType, List<JokeImageAndTextListBean.ContentlistBean> dataList, RecyclerView recyclerView, int mItemLayoutId) {
        super(dataList, recyclerView, mItemLayoutId);
        mJokeType=jokeType;
    }
    @Override
    public void onBindViewHolderInner(RecyclerView.ViewHolder viewHolder, int realPosition, JokeImageAndTextListBean.ContentlistBean data) {
